...
export default function Mindfulness() {
    return (
        ...
        <p className="mb-2">La atención plena también implica aceptación, lo que significa que prestamos atención a nuestros 
            pensamientos y sentimientos sin juzgarlos, sin creer, por ejemplo, que hay una forma "correcta" o 
            "incorrecta" de pensar o sentir en un momento dado. Cuando practicamos la atención plena, nuestros 
            pensamientos se sintonizan con lo que percibimos en la experiencia presente.</p>
        <p className="mb-2">Aunque tiene sus raíces en la meditación budista, la práctica secular de la atención plena se ha 
            generalizado en el mundo en los últimos años, en parte gracias al trabajo de Jon Kabat-Zinn y su 
            programa de Reducción del Estrés Basada en la Atención Plena (MBSR, por sus siglas en inglés), 
            que puso en marcha en la Facultad de Medicina de la Universidad de Massachusetts en 1979. Desde 
            entonces, miles de estudios han documentado los beneficios para la salud física y mental de la 
        ...
        <p className="mb-2">Dicho lo anterior, es importante destacar que el Mindfulness no es una "técnica" ni se trata de 
            ...
            dolor, reactividad, estrés, dolor o trauma- podemos recurrir a estas habilidades y prácticas para que 
            nos ayuden a responder de un modo que esté en consonancia con nuestros valores más profundos y nuestra 
            sabiduría.</p>
        <p className="mb-2">Esta forma especial de prestar atención a lo que está ocurriendo, nos ayuda a establecer una mejor 
            conexión con la experiencia y percibirla con mayor claridad, a ver más cosas e identificar posibilidades 
            que de otra forma nos hubieran pasado desapercibidas.</p>
        <p className="mb-2">En principio parece muy sencillo. Todos somos capaces de prestar atención a lo que está ocurriendo a 
            nuestro alrededor en un determinado instante. Sin embargo, mantener la atención en cada momento es 
            más difícil porque la mente tiende a irse constantemente al pasado o al futuro.</p>
        ...
        <p className="mb-2"><strong>No hay forma de silenciar o poner la mente en blanco.</strong> Ese no es el objetivo de la 
            meditación. Mientras meditamos no buscamos un estado de felicidad ni una comunión de otro mundo. Todo 
            lo que intentamos hacer es prestar atención al momento presente, sin juzgar.</p>
        <p className="mb-2"><strong>Tu mente divagará.</strong> Cuando practiques prestar atención a lo que ocurre en tu cuerpo y 
            en tu mente en el momento presente, verás que surgen muchos pensamientos y distracciones. Pero la mente 
            errante no es algo que haya que temer, forma parte de la naturaleza humana y proporciona el momento clave 
            de la práctica de la atención: el momento en el que reconoces que tu mente ha divagado. Porque si te das 
        ...
        <p className="mb-2"><strong>Se trata de volver una y otra vez al momento presente.</strong> Parece que nuestras mentes están 
            programadas para dejarse llevar por los pensamientos. Por eso la atención plena es la práctica de volver, 
            una y otra vez, al ancla al momento presente que hemos escogido.</p>
        <p className="mb-2"><strong>La Autocompasión implica actuar hacia nosotros mismos</strong>, de la misma manera que trataríamos 
            a los demás, cuando estamos teniendo un momento difícil, cuando fallamos, o notamos algo que no nos gusta 
            de nosotros mismos.</p>
        <p className="mb-2"><strong>Todas estas prácticas formales también pueden adaptarse a la práctica informal o "mindfulness 
        ...
        <p className="mb-2"><strong>Paciencia.</strong> Una forma de sabiduría, la paciencia demuestra que aceptamos el hecho de que, 
            a veces, las cosas se desarrollan a su debido tiempo. Permitirlo.</p>
        <p className="mb-2"><strong>Mente de principiante.</strong> Permanecer abiertos y curiosos nos permite ser receptivos a nuevas 
        ...
        <p className="mb-2"><strong>Soltar.</strong> Cuando prestamos atención a nuestra experiencia interior, descubrimos que hay 
            ciertos pensamientos, emociones y situaciones a los que la mente quiere aferrarse. Deja que tu experiencia 
            sea lo que es en este momento</p>
        <p className="mb-2"><strong>Gratitud.</strong> Tiene que ver con traer gratitud al momento presente. Partir agradeciendo porque 
            estamos vivos y al observar con atención no dar por sentadas nuestras bendiciones.</p>
        ...
        <p className="mb-2">El Mindfulness o atención plena, no consiste en cambiar las cosas o situaciones, sino en cambiar la 
            percepción de estas y de esta percepción surgen nuevas oportunidades para modificar pensamientos, 
            acciones y con ello poder influir directamente en uno mismo y en el entorno.</p> 
        ...
        <ol className="ml-8">
            ...
            <ol className="ml-8">
                ...
                <li className="mb-2">(ii) <strong>Corteza cingulada anterior:</strong> Se la considera como un intermedio entre 
                la corteza primitiva y la neocortex, no solo desde el punto de vista filogenético y estructural, sino también por 
                ...
                a un debilitamiento de las respuestas autonómicas.</p>
            ...
            <p className="mb-2">El nivel superior del sistema límbico representa un puente conector entre los componentes de la psique inconsciente y 
                ...
                través del entrenamiento y práctica de la atención plena, lo que entre otros aspectos se traducirá en la mejoría de la 
                autorregulación de la capacidad de gestionar las emociones, especialmente, las relacionadas con el estrés. Se empiezan 
                a reconocer y romper asociaciones y así poder modificar patrones de valores y comportamientos arraigados. Otro aspecto 
        ...
        <ul className="ml-8">
            <li className="mb-2">• Crecimiento de la corteza prefrontal e insular.</li>
            <li className="mb-2">• Menor actividad de la amígdala.</li>
            <li className="mb-2">• Mayor activación del hemisferio cerebral izquierdo.</li>
            <li className="mb-2">• Favorece procesos neurológicos de abajo hacia arriba.</li>
            <li className="mb-2">• Mejora la capacidad de concentración, atención selectiva y sostenida, función ejecutiva, memoria, capacidad y desempeño cognitivos.</li>
            <li className="mb-2">• Estimula la creatividad, la eficiencia del aprendizaje, el esfuerzo.</li>
        </ul>
        <p className="mb-2">Psicológicos:</p>
        <ul className="ml-8">
            <li className="mb-2">• Mejora del ánimo, autoestima y compasión.</li>
            <li className="mb-2">• Mejora la capacidad de responder y no reaccionar.</li>
            <li className="mb-2">• Mejora la capacidad de autorregulación emocional.</li>
            <li className="mb-2">• Efectos positivos en la depresión, ansiedad generalizada y social.</li>
            <li className="mb-2">• Reduce el comer compulsivamente, el uso de sustancias y el comportamiento agresivo.</li>
            <li className="mb-2">• Disminución de la tendencia a la rumiación mental.</li>
            <li className="mb-2">• Disminuye los trastornos del sueño.</li>
        </ul>
        <p className="mb-2">Físicos:</p>
        <ul className="ml-8">
            <li className="mb-2">• Mejora funcionamiento inmune y salud cardiovascular.</li>
            <li className="mb-2">• Mejora los hábitos alimenticios.</li>
            <li className="mb-2">• Parece ayudar con el asma, inflamaciones y tiempo de recuperación postoperatorio.</li>
