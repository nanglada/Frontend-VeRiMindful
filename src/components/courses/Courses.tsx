    ...
    return (
        ...
        <Navbar/>
            <div className="grid place-items-center mt-8">
                <h1 className="text-3xl font-logo text-orange1 mb-2">Próximos talleres</h1>
                <h3 className="mb-8 text-lg">
                    Facilitadora: <a href="/quién soy" className="underline hover:text-blue1">Verónica Riera</a>
                </h3>
                {
